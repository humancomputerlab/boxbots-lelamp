...
Then you need to set up [LeLamp Runtime](https://github.com/humancomputerlab/boxbots_lelamp_runtime):

```bash
git clone https://github.com/humancomputerlab/boxbots_lelamp_runtime.git
```
