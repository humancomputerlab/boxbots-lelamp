...
Using [Pi Imager](https://www.raspberrypi.com/software/), flash **Raspberry Pi OS Lite (64-bit)** onto your Raspberry Pi. You can reference how to do this [here](httpss://www.raspberrypi.com/documentation/computers/getting-started.html).
...
Make sure to use your mobile hotspot only.
...
Then you need to set up [LeLamp Runtime](https://github.com/humancomputerlab/boxbots_lelampruntime):

```bash
git clone https://github.com/humancomputerlab/boxbots_lelampruntime.git
```
...
This will take a while. If uv is not recognized you will have to restart the terminal.
...
5. Check if your device is enabled:
   ...
   **Note:** The alsamixer interface requires a full terminal emulator and may not work properly in IDE integrated terminals.
...
You should hear a beep, audio will be recorded and then replayed.
